...
impl NodeType {
    ...
    pub const fn kind(self) -> NodeKind {
        match self {
            Self::ComputeGb200Nvidia | Self::ComputeGb300Nvidia | Self::ComputeGb300Lenovo => {
                NodeKind::Compute
            }
            ...
            Self::SwitchGb200Nvidia | Self::SwitchGb300Nvidia => NodeKind::Switch,
        }
    }
    ...
    pub const fn product_family(self) -> ProductFamily {
        match self {
            ...
            | Self::ComputeGb300Lenovo => ProductFamily::Gb300,
        }
    }
    ...
    pub const fn nvfwupd_server_profile(self) -> NvfwupdServerProfile {
        match self {
            Self::ComputeGb200Nvidia => NvfwupdServerProfile::ComputeGb200,
            Self::ComputeGb300Nvidia | Self::ComputeGb300Lenovo => {
