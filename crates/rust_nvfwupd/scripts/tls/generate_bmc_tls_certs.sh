...
Examples:
  crates/rust_nvfwupd/scripts/tls/generate_bmc_tls_certs.sh --ip 192.0.2.10 --out-dir /tmp/bmc-192.0.2.10-tls
  crates/rust_nvfwupd/scripts/tls/generate_bmc_tls_certs.sh --ip 192.0.2.10 --dns bmc.example.com
...
echo
echo "Upload to BMC:"
echo "  crates/rust_nvfwupd/scripts/tls/load_bmc_tls_cert.sh --ip $ip --user <user> --password <password> --cert-dir $out_dir"
echo
