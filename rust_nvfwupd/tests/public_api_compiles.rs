...
fn public_modules_and_targets_are_addressable() {
    ...
    assert_type_is_public::<nvfwupd::hgxb100_rftarget::MGXNVLRFTarget>();
    ...
    assert_type_is_public::<nvfwupd::targets::MGXNVLRFTarget>();
    ...
    assert!(!nvfwupd::ipmitool_api::IPMI_CMD_DICT.is_empty());
    assert!(!nvfwupd::rf_target::SERVER_TYPE_CLASS_DICT.is_empty());
