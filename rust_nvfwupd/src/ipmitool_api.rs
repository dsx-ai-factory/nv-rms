...
pub static IPMI_CMD_DICT: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
...
static IPMITOOL_AVAILABILITY: Lazy<Mutex<HashMap<String, Result<(), String>>>> =
...
mod tests {
    ...
    static IPMI_TEST_LOCK: Lazy<Mutex<()>> = Lazy::new(|| Mutex::new(()));
