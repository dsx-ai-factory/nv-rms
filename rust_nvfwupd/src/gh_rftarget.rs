...
//! GHRFTarget implementation for GH/HGX/MGX/Falcon/Starship platforms
//! (UT 2.1 / OpenBMC).
...
/// Platform-specific RFTarget for GH, HGX, MGX, Falcon, and Starship
/// systems running UT 2.1 / OpenBMC firmware.
