...
pub static SERVER_TYPE_CLASS_DICT: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    m.insert("mgx-nvl", "MGXNVLRFTarget");
    m.insert("gb200switch", "GB200SwitchRFTarget");
    m.insert("gb300switch", "GB200SwitchRFTarget");
    // vrswitch hidden from help text and manpage for now, but still supported
    m.insert("vrswitch", "GB200SwitchRFTarget");
    m.insert("vrnvl72switch", "GB200SwitchRFTarget");
    // vr hidden from help text and manpage for now, but still supported
    m.insert("vr", "GB200RFTarget");
...
pub static TARGET_CLASS_DICT: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
    m.insert("ut2.1 dp chassis", "GHRFTarget");
    m.insert("hgx", "GHRFTarget");
    m.insert("dgx", "DGX_RFTarget");
    m.insert("dgxrubin", "DGX_RFTarget");
    m.insert("dgx rubin", "DGX_RFTarget");
    m.insert("falcon", "GHRFTarget");
    m.insert("starship", "GHRFTarget");
    m.insert("ranger_keystone", "GHRFTarget");
    m.insert("e4870", "GHRFTarget");
    m.insert("e4866", "GHRFTarget");
    m.insert("p5042", "GHRFTarget");
    m.insert("p5041", "GHRFTarget");
    m.insert("p4498", "GHRFTarget");
    m.insert("nvidia-bmcmezz", "GHRFTarget");
    m.insert("p3809", "GH200RFTarget");
    m.insert("p4764", "GH200RFTarget");
    m.insert("e4869", "GHRFTarget");
    m.insert("p4984 a00", "GHRFTarget");
    m.insert("p2312", "GHRFTarget");
    ...
    m.insert("vr200 nvl", "GB200RFTarget");
    m.insert("vr200 nvl72", "GB200RFTarget");
    ...
    m.insert("e5010", "GB200RFTarget");
    m.insert("p5035", "GB200RFTarget");
    m.insert("vr nvl144", "GB200RFTarget");
    m
});

/// Maps BMC type configuration strings to their corresponding RFTarget
/// implementation class name.
pub static TARGET_TYPE_CONFIG_DICT: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    let mut m = HashMap::new();
